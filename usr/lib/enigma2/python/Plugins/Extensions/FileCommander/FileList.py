...
from enigma import RT_HALIGN_LEFT, BT_SCALE, eListboxPythonMultiContent, eServiceReference, eServiceCenter, getDesktop
# commented out
#eServiceReferenceFS,
...
if screenwidth > 1280:
	imagePath = resolveFilename(SCOPE_PLUGINS, base="Extensions/FileCommander/images/FHD/")
else:
	imagePath = resolveFilename(SCOPE_PLUGINS, base="Extensions/FileCommander/images/HD/")
...
def FileEntryComponent(name, absolute=None, isDir=False, isLink=False):
	...
	if screenwidth > 1280:
		x, y, w, h = skin.parameters.get("FcFileListName", (55, 1, 1200, 43))
	else:
		x, y, w, h = skin.parameters.get("FcFileListName", (37, 1, 800, 28))
	...
	if png is not None:
		if screenwidth > 1280:
			x, y, w, h = skin.parameters.get("FcFileListIcon", (15, 6, 30, 30))
		else:
...
def MultiFileSelectEntryComponent(name, absolute=None, isDir=False, isLink=False, selected=False):
	...
	if screenwidth > 1280:
		x, y, w, h = skin.parameters.get("FcFileListMultiName", (84, 1, 1200, 43))
	else:
		x, y, w, h = skin.parameters.get("FcFileListMultiName", (56, 1, 800, 28))
	res.append((eListboxPythonMultiContent.TYPE_TEXT, x, y, w, h, 0, RT_HALIGN_LEFT, name))
	...
	if png is not None:
		if screenwidth > 1280:
			x, y, w, h = skin.parameters.get("FcFileListMultiIcon", (45, 6, 30, 30))
		else:
	...
	if not name.startswith('<'):
		if screenwidth > 1280:
			x, y, w, h = skin.parameters.get("FcFileListMultiLock", (6, 0, 37, 37))
		else:
