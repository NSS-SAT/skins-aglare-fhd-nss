...
def Plugins(**kwargs):
    return PluginDescriptor(name='Setup Aglare NSS', description=_('Customization tool for Aglare-FHD-NSS Skin'), where=PluginDescriptor.WHERE_PLUGINMENU, icon='plugin.png', fnc=main)
